    ...
    <section className="py-16 lg:py-36 px-6">
      ...
      <div className="flex justify-center">
        <a
          ...
          target="_blank"
          className="border-2 border-mainColor py-3 px-8 text-mainColor rounded-full hover:bg-mainColor hover:text-white transition duration-500 ease-in-out tracking-wide flex items-center"
        >
          <Github />
