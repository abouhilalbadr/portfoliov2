    ...
    return (
        <div className="w-full lg:w-1/3" {...extra}>
            ...
            >
                ...
                <div
                    className={
                        "px-8 flex flex-col justify-center items-center text-white w-full h-full absolute top-0 left-0 bg-secondColor rounded-xl transition duration-500 ease-in-out " +
